		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create Seed Orders",
									"targetURL": "#vcpvcpseedordercreationnew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vcpvcpseedordercreationnew-display": {
								"semanticObject": "vcpvcpseedordercreationnew",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vcp.vcpseedordercreationnew",
									"url": sap.ui.require.toUrl("vcp/vcpseedordercreationnew")
								}
							}
						}
					}
